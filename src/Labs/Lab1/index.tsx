    ...
    return (
        <div id="wb-lab1">
            ...
            <div id="wd-p-tag">
                ...
                the paragraph above and this paragraph, by default browsers render them as one contiguous 
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Chop chicken breast into cubes</li>
                    <li>Lightly grease pan, then set skillet to medium heat</li>
                    <li>Add chicken cubes</li>
                    <li>While the chicken cooks, prepare the sauce</li>
                    <li>Combine equal parts minced garlic, soy sauce, and honey into a bowl</li>
                    <li>After finished with the sauce, add broccoli to the skillet</li>
                    <li>Once the chicken and broccoli are cooked through, add the sauce</li>
            ...
            <div id="wd-images">
                <h4>Image Tag</h4>
                Loading and image from the internet: <br />
