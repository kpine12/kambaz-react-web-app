...
export default function AssignmentEditor() {
    ...
    return (
        <div id="wd-assignments-editors">
            ...
            { assignments.filter((assignment : any) => assignment.course === cid && assignment._id === aid)
            .map((assignment: any) => (
                <div>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="points">
                            ...
                            <Col sm={10}>
                                <Form.Control placeholder={ assignment.points}/>
                            </Col>
                    </Form.Group><br/>
                            ...
                            <Card.Body>
                                ...
                                <Form>
                                    <InputGroup className="mb-3">
                                        <Col sm={8}>
                                            <Form.Control placeholder={ assignment.dueDate }/>
                                        </Col>
                                ...
                                <Form>
                                    <InputGroup className="mb-3">
                                        <Col sm={3}>
                                            <Form.Control placeholder={ assignment.availableDate }/>
                                        </Col>
                                        <InputGroup.Text><IoCalendarOutline className="position-relative me-2" style={{ bottom: "1px" }}/></InputGroup.Text>
                                    </InputGroup>
                                </Form>
